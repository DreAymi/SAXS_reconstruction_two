...
def decode(z,batchsize):
	...
	with tf.variable_scope('deconv1') as scope:
		...
		deconv=tf.nn.conv3d_transpose(h,weight,[batchsize,16,16,16,64],[1,2,2,2,1],padding='SAME')
	...
	with tf.variable_scope('deconv2') as scope:
		...
		deconv=tf.nn.conv3d_transpose(deconv1,weight,[batchsize,32,32,32,128],[1,2,2,2,1],padding='SAME')
