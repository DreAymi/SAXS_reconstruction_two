...
with tf.device('/cpu:0'):
	train_data,train_label=read_tfrecords('../autoencoder_traindata/train.tfrecords')
	...
	test_data,test_label=read_tfrecords('../autoencoder_traindata/test.tfrecords')
